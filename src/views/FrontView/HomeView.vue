<template>
    ...
    <div class="container">
      <div class="d-flex justify-content-center align-items-center">
        <div class="text-center text-white">
          <h2 class="pb-7">不再害怕上路</h2>
          <h2>道路駕駛陪你一起<span class="ps-2 text-secondary">上山下海</span></h2>
        </div>
      </div>
    </div>
  </div>
  <section class="carousel">
    <div class="container">
      <div class="text-center text-primary mt-5 mb-9">
        <p class="main-title fs-1 fw-bold">
          你害怕的是什麼
        </p>
      </div>
      <div class="d-lg-none d-md-none row d-grid gap-4">
        <ul class="col-12 situation-group d-grid gap-7">
      ...
      <div class="d-lg-flex d-md-flex d-none row flex-wrap">
        <ul class="col-4 situation-group d-grid gap-7">
          <li class="situation-item d-flex justify-content-center">
            <span>01</span>
            <img src="https://storage.googleapis.com/vue-course-api.appspot.com/reirei/1725180627238.png?GoogleAccessId=firebase-adminsdk-zzty7%40vue-course-api.iam.gserviceaccount.com&Expires=1742169600&Signature=pwc3d1xBc1aw9U%2BbU8hHeLL6ibHWQbPvseEtO7hQsZgeTJrNj1hUKLblvA0ZEUlHYDr%2BMMXKhtrUrxsTLtNBQNM8FxJGoB7jzxjZtUtj04YCss6Sd7qNvb24W8xuFK6xm7dUAD8o76BPifs5pC7Ma%2BgCiG9Lig2Lo%2Fqq1E%2FM7yg2F44zaDPCYx2empFqLpxPHn7ST2ASOQ6eHOUh2c67%2BBrSG%2Fogvj9q6UB5QC6w%2BwjJUtxDnZztXWJK9D8hpxdq7curxR0ozdA%2FN%2F2eYYJ%2BWrbcnrTTpauU7XoFqVDEewh%2FAb3pQ57%2BxbYPFpCY2JHQqga7PbHIUx%2B0QjEE4wwzzQ%3D%3D" alt="situation" class="situation-img">
          </li>
...
<style lang="scss" scoped>
  ...
  .banner2{
    background: url('https://storage.googleapis.com/vue-course-api.appspot.com/reirei/1725345359327.png?GoogleAccessId=firebase-adminsdk-zzty7%40vue-course-api.iam.gserviceaccount.com&Expires=1742169600&Signature=BYllpkir43Sohcq%2BQzM6dHLK72twTU0zdOeBr1H8YY1YAwKAotwIvaXnH6sEXN2VMpb2lxg0d7vdKcoepw8EjaPfU8XJwm0U7JvldZizlXObXIHvYWCQJFwfZkdDTpa%2FVd42Q49CG5bY5XsgGpPbprHz08an1wNA2mNonVtRvWrmjCH0BNNPareVWtp0naJ7jDDoipIZ8uJOFHiqclYClqiGDYeuWMH25dL%2FaaBF6%2BYgv3A8QYERzs7nXo6qvw1ShxNrSUbC%2FH99ib%2FRYfj4spSIGIwIouOfQffqXMWhluuCr6r9EtQWMRG%2B0BJuxe3PGIpEgjhsLvWZydy%2Bj%2Fnc0A%3D%3D') no-repeat center center / cover;
    width: 100%;
  }
  .banner2-title{
