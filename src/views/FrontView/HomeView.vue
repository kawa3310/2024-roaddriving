<template>
  ...
  <section class="carousel">
    <div class="container">
      ...
      <div class="d-lg-none d-md-none d-grid gap-5">
        <ul class="col-12 situation-group d-grid gap-7 pb-3">
      ...
      <HomeSwiper class="d-lg-block d-md-block d-none"></HomeSwiper>
    </div>
  </section>
