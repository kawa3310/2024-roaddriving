...
.main-title{
  ...
  .reservation-bg{
    background: url('https://storage.googleapis.com/vue-course-api.appspot.com/rei/1742223784926.jpg') no-repeat center bottom / cover;
    width: 100%;
  }
  .bg-card{
  ...
  .hot-logo{
    position: absolute;
    background: url('https://storage.googleapis.com/vue-course-api.appspot.com/reirei/1726142978878.png') no-repeat center center / cover;
    height: 44px;
    width: 44px;
    top: 0%;
    left: 2%;
