...
<style>
  ...
  100.00%
  {
    ...
    cubic-bezier(0.53,0.08,0.77,0.57);
...
.el-loading-spinner{
  width: 47px;
  height: 47px;
  background: url('/public/loading.svg') no-repeat;
